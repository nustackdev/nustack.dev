...
# 📄 `loomi._app.handlers.execution_handler` Reference
...
| ---- | ---- | ----- | ----------- |
| `ex` | `property` | `&lt;property object at 0x10f3e62f0&gt;` |  |
| `executor` | `property` | `&lt;property object at 0x10f423ce0&gt;` |  |
...
| Name | Type | Value | Description |
| ---- | ---- | ----- | ----------- |
| `ex` | `property` | `&lt;property object at 0x10f3e6430&gt;` |  |
| `executor` | `property` | `&lt;property object at 0x10f3e6390&gt;` |  |
