...
/**
 * NuLogo — lowercase "nu" letterform, vectorized from the source PNG.
 * Diagonal purple → blue gradient (brand duo, palette 500 anchors),
 * TL → BR by default. Override via `from` / `to`.
 */
