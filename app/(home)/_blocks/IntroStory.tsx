...
/**
 * IntroStory — chapter header + body. Body is one Cell where every beat
  ...
  return (
    <>
      ...
      <Row cols={1} borderBottom="solid" borderLeft="solid" borderRight="solid">
        <Cell className={ps.chapterCell}>
          <span className={ps.chapterPeek} aria-hidden>intro</span>
          <CellContent pad="lg">
            <Heading level={1}>Meet Nu.</Heading>
            <p className={ps.sectionIntro}>
              What Nu is, how it works, why it matters &mdash; in one read.
            </p>
          </CellContent>
        </Cell>
      </Row>
