...
# 📄 `loomi.interfaces.state.tree` Reference
...
| ---- | ---- | ----- | ----------- |
| `is_async` | `property` | `&lt;property object at 0x10f515a30&gt;` |  |
| `path` | `property` | `&lt;property object at 0x10f515ad0&gt;` |  |
...
| Name | Type | Value | Description |
| ---- | ---- | ----- | ----------- |
| `is_sync` | `property` | `&lt;property object at 0x10f515df0&gt;` |  |
| `path` | `property` | `&lt;property object at 0x10f515e40&gt;` |  |
