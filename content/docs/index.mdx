...
| [`nu.kv`](/docs/reference/fabrics/virtuals) | Persistent state fabric. Refs over a KV backend (RocksDB, LMDB); transactions, snapshots, and change notifications, built in. |
...
| [`nu.invisibles`](/docs/reference/fabrics/invisibles) | Network fabric. Puts other fabrics on the network. Bind a fabric in one process, use it from another; same Refs, same interactions, over TCP or Unix socket. |
