...
# 📄 `loomistd.codec._passthrough_codec.codec` Reference

## Classes

<Cards>
  <Cards.Card title="PassthroughCodec" href="#passthroughcodec"/>
  <Cards.Card title="PassthroughCodecSpec" href="#passthroughcodecspec"/>
</Cards>

---

<a id='passthroughcodec'></a>
...
| ---- | ---- | ----------- | ------- |
| `encoded` | `PassthroughCodecEncodedKey` | String to decode | `Required` |

**Returns:** `PassthroughCodecKey` - Original key tuple
...
| Name | Type | Description | Default |
| ---- | ---- | ----------- | ------- |
| `encoded` | `PassthroughCodecEncodedValue` | Value to decode | `Required` |

**Returns:** `PassthroughCodecValue` - Same value without modification
...
| Name | Type | Description | Default |
| ---- | ---- | ----------- | ------- |
| `key` | `PassthroughCodecKey` | Key to encode (tuple) | `Required` |

**Returns:** `PassthroughCodecEncodedKey` - String representation of key
...
| Name | Type | Description | Default |
| ---- | ---- | ----------- | ------- |
| `value` | `PassthroughCodecValue` | Value to encode | `Required` |

**Returns:** `PassthroughCodecEncodedValue` - Same value without modification
